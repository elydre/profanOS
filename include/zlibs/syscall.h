...
#define c_mem_get_alloc_size ((uint32_t (*)(uint32_t)) hi_func_addr(14))
#define c_mem_alloc ((uint32_t (*)(uint32_t, int)) hi_func_addr(15))
#define c_mem_free_addr ((int (*)(uint32_t)) hi_func_addr(16))
#define c_mem_get_info ((int (*)(int, int)) hi_func_addr(17))

#define c_time_get ((void (*)(time_t *)) hi_func_addr(18))
#define c_timer_get_tick ((uint32_t (*)(void)) hi_func_addr(19))

#define c_font_get ((uint8_t *(*)(int)) hi_func_addr(20))
#define c_clear_screen ((void (*)(void)) hi_func_addr(21))
#define c_ckprint_at ((void (*)(char *, int, int, char)) hi_func_addr(22))
#define c_kprint_backspace ((void (*)(void)) hi_func_addr(23))
#define c_set_cursor_offset ((void (*)(int)) hi_func_addr(24))
#define c_get_cursor_offset ((int (*)(void)) hi_func_addr(25))
#define c_gt_get_max_rows ((int (*)(void)) hi_func_addr(26))
#define c_gt_get_max_cols ((int (*)(void)) hi_func_addr(27))
#define c_cursor_blink ((void (*)(int)) hi_func_addr(28))
#define c_vesa_set_pixel ((void (*)(int, int, uint32_t)) hi_func_addr(29))

#define c_kb_scancode_to_char ((char (*)(int, int)) hi_func_addr(30))
#define c_kb_get_scancode ((int (*)(void)) hi_func_addr(31))
#define c_kb_reset_history ((void (*)(void)) hi_func_addr(32))
#define c_kb_get_scfh ((int (*)(void)) hi_func_addr(33))

#define c_sys_reboot ((void (*)(void)) hi_func_addr(34))
#define c_sys_shutdown ((void (*)(void)) hi_func_addr(35))
#define c_run_ifexist ((int (*)(char *, int, char **)) hi_func_addr(36))

#define c_task_switch ((void (*)(int)) hi_func_addr(37))
#define c_task_get_alive ((int (*)(void)) hi_func_addr(38))
#define c_task_get_max ((int (*)(void)) hi_func_addr(39))

#define c_serial_print ((void (*)(int, char *)) hi_func_addr(40))

#define c_ramdisk_get_size ((uint32_t (*)(void)) hi_func_addr(41))
#define c_ramdisk_get_used ((uint32_t (*)(void)) hi_func_addr(42))
