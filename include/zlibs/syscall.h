...
#define c_pow ((int (*)(int, int)) hi_func_addr(59))
#define c_rand ((int (*)(void)) hi_func_addr(60))
#define c_sys_reboot ((void (*)(void)) hi_func_addr(62))
#define c_ramdisk_read_sector ((void (*)(uint32_t, uint32_t *)) hi_func_addr(63))
#define c_ramdisk_write_sector ((void (*)(uint32_t, uint32_t *)) hi_func_addr(64))
...
#define c_vgui_draw_rect ((void (*)(int, int, int, int, unsigned)) hi_func_addr(96))
#define c_vgui_set_pixel ((void (*)(int, int, unsigned)) hi_func_addr(97))
#define c_vgui_get_pixel ((unsigned (*)(int, int)) hi_func_addr(98))
#define c_vgui_print ((void (*)(int, int, char *, unsigned)) hi_func_addr(99))
#define c_task_get_max ((int (*)(void)) hi_func_addr(100))
#define c_serial_debug ((void (*)(char *, char *)) hi_func_addr(102))
