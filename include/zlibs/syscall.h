...
#define c_serial_print ((void (*)(int, char *)) hi_func_addr(42))
#define c_mouse_call ((int (*)(int, int)) hi_func_addr(43))

#define c_ramdisk_get_size ((uint32_t (*)(void)) hi_func_addr(44))
#define c_ramdisk_get_used ((uint32_t (*)(void)) hi_func_addr(45))

#define c_process_create ((int (*)(void (*func)(), char *)) hi_func_addr(46))
#define c_process_sleep ((void (*)(int, uint32_t)) hi_func_addr(47))
#define c_process_wakeup ((void (*)(int)) hi_func_addr(48))
#define c_process_kill ((void (*)(int)) hi_func_addr(49))
#define c_process_exit ((void (*)(void)) hi_func_addr(50))
...
#define c_process_get_custom ((void *(*)(int)) hi_func_addr(56))
#define c_process_set_custom ((void (*)(int, void *)) hi_func_addr(57))
#define c_process_get_run_time ((uint32_t (*)(int)) hi_func_addr(58))
