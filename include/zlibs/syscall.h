...
#define c_kb_scancode_to_char ((char (*)(int, int)) hi_func_addr(33))
#define c_kb_get_scancode ((int (*)(void)) hi_func_addr(34))
#define c_kb_reset_history ((void (*)(void)) hi_func_addr(35))
#define c_kb_get_scfh ((int (*)(void)) hi_func_addr(36))

#define c_sys_reboot ((void (*)(void)) hi_func_addr(37))
#define c_sys_shutdown ((void (*)(void)) hi_func_addr(38))
#define c_run_ifexist ((int (*)(char *, int, char **)) hi_func_addr(39))

#define c_serial_print ((void (*)(int, char *)) hi_func_addr(40))
#define c_mouse_call ((int (*)(int, int)) hi_func_addr(41))
