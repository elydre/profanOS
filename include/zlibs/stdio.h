...
#define freopen ((FILE * (*)(const char *, const char *, FILE *)) get_func_addr(STDIO_ID, 7))
#define freopen_s ((errno_t (*)(FILE * *, const char *, const char *, FILE *)) get_func_addr(STDIO_ID, 8))
#define fclose ((int (*)(FILE *)) get_func_addr(STDIO_ID, 9))
#define fflush ((int (*)(FILE *)) get_func_addr(STDIO_ID, 10))
#define setbuf ((void (*)(FILE *, char *)) get_func_addr(STDIO_ID, 11))
#define setvbuf ((int (*)(FILE *, char *, int, size_t)) get_func_addr(STDIO_ID, 12))
#define fwide ((int (*)(FILE *, int)) get_func_addr(STDIO_ID, 13))
#define fread ((size_t (*)(void *, size_t, size_t, FILE *)) get_func_addr(STDIO_ID, 14))
#define fwrite ((size_t (*)(const void *, size_t, size_t, FILE *)) get_func_addr(STDIO_ID, 15))
