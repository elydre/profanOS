...
#define wadds_putc ((void (*)(window_t *, int, int, char, uint32_t, uint32_t)) get_func_addr(WADDS_ID, 5))
#define wadds_puts ((void (*)(window_t *, int, int, char*, uint32_t, uint32_t)) get_func_addr(WADDS_ID, 6))
