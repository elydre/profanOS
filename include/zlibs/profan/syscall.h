...
DEFN_SYSCALL0(41, int,      eth_listen_start)
DEFN_SYSCALL0(42, int,      eth_listen_end)
DEFN_SYSCALL1(43, int,      eth_listen_get, void *)
DEFN_SYSCALL0(44, uint32_t, eth_listen_getsize)
DEFN_SYSCALL0(45, uint32_t, eth_listen_isready)
DEFN_SYSCALL2(46, int,      eth_send, void *, uint32_t)
DEFN_SYSCALL1(47, int,      eth_get_mac, uint8_t *)
DEFN_SYSCALL0(48, uint32_t, eth_get_transaction_id)
DEFN_SYSCALL1(49, int,      eth_set_ip, uint8_t *)
DEFN_SYSCALL1(50, int,      eth_get_ip, uint8_t *)
