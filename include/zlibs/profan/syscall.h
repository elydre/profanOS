...
DEFN_SYSCALL1(27, int,       process_auto_schedule, int)
DEFN_SYSCALL4(28, int,       process_create, void *, int, int, uint32_t *)
DEFN_SYSCALL0(29, int,       process_fork)
DEFN_SYSCALL2(30, int,       process_sleep, uint32_t, uint32_t)
DEFN_SYSCALL2(31, int,       process_wakeup, uint32_t, int)
DEFN_SYSCALL3(32, int,       process_wait, int, uint8_t *, int)
DEFN_SYSCALL2(33, int,       process_kill, uint32_t, int)
DEFN_SYSCALL0(34, uint32_t,  process_pid)
DEFN_SYSCALL3(35, int,       process_info, uint32_t, int, void *)
DEFN_SYSCALL2(36, int,       process_list_all, uint32_t *, int)

DEFN_SYSCALL2(37, int,       mod_load, char *, uint32_t)
DEFN_SYSCALL1(38, int,       mod_unload, uint32_t)

DEFN_SYSCALL2(39, void *,    scuba_generate, void *, uint32_t)
DEFN_SYSCALL3(40, int,       scuba_map, void *, void *, int)
DEFN_SYSCALL1(41, int,       scuba_unmap, void *)
DEFN_SYSCALL1(42, void *,    scuba_phys, void *)
