...
#define fu_is_dir ((int (*)(uint32_t)) get_func_addr(FILESYS_LIB_ID, 0))
#define fu_dir_get_size ((int (*)(uint32_t)) get_func_addr(FILESYS_LIB_ID, 1))
#define fu_dir_get_elm ((int (*)(uint8_t *, uint32_t, uint32_t, uint32_t *)) get_func_addr(FILESYS_LIB_ID, 2))
#define fu_dir_get_content ((int (*)(uint32_t, uint32_t **, char ***)) get_func_addr(FILESYS_LIB_ID, 3))
...
#define fu_dir_create ((uint32_t (*)(int, const char *)) get_func_addr(FILESYS_LIB_ID, 6))
...
#define fu_fctf_create ((uint32_t (*)(int, const char *, int (*)(int, void *, uint32_t, uint8_t))) get_func_addr(FILESYS_LIB_ID, 14))
#define fu_fctf_get_addr ((void *(*)(uint32_t)) get_func_addr(FILESYS_LIB_ID, 15))
...
#define fm_read ((int (*)(int, void *, uint32_t)) get_func_addr(FMOPEN_LIB_ID, 2))
#define fm_write ((int (*)(int, void *, uint32_t)) get_func_addr(FMOPEN_LIB_ID, 3))
...
#define fm_newfd_after ((int (*)(int)) get_func_addr(FMOPEN_LIB_ID, 10))
