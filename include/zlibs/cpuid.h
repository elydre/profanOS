...
|   === cpuid.h : 2025 ===                                                    |
|                                                                             |
|    Implementation of the cpuid.h header file from libC           .pi0iq.    |
|                                                                 d"  . `'b   |
|    This file is part of profanOS - under GPLv3                  q. /|\  "   |
|    Original header - the GNU libc                                `// \\     |
|                                                                  //   \\    |
...
// Signatures for different CPU as returned by cpuid instruction
...
static inline unsigned int __get_cpuid_max(unsigned int __ext, unsigned int *__sig) {
    ...
    #else
    // GCC older than 3.0 weren't supporting Intel asm syntax nor alternatives
        asm (
            "pushfl\n\t"
            "pushfl\n\t"
            "popl\t%0\n\t"
...
static __inline int __get_cpuid_count(
            unsigned int __leaf, unsigned int __subleaf,
            unsigned int *__eax, unsigned int *__ebx,
            unsigned int *__ecx, unsigned int *__edx)
{
    unsigned int __ext = __leaf & 0x80000000;
