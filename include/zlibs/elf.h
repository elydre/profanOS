...
#define ELFOSABI_ARM_AEABI  64      // ARM with EABI
...
#define SHN_AFTER           0xff01          // Order section after all othe (Solaris)
...
#define SHT_SUNW_move       0x6ffffffa      // Sun-specific move table
#define SHT_SUNW_COMDAT     0x6ffffffb      // Sun-specific comdat
#define SHT_SUNW_syminfo    0x6ffffffc      // Sun-specific symbol information
...
#define DT_POSFLAG_1        0x6ffffdfd      // Flags for DT_* entries
...
typedef struct {
    ...
    Elf32_Word      vda_next;           // Offset in bytes to next verda
} Elf32_Verdaux;

typedef struct {
    Elf64_Word      vda_name;           // Version or dependency names
    Elf64_Word      vda_next;           // Offset in bytes to next verda
} Elf64_Verdaux;
...
typedef struct {
    ...
    Elf32_Word      vn_file;            // Offset of filename for th
    Elf32_Word      vn_aux;             // Offset in bytes to vernaux array
    Elf32_Word      vn_next;            // Offset in bytes to next verne
} Elf32_Verneed;

typedef struct {
    Elf64_Half      vn_version;         // Version of structure
    Elf64_Half      vn_cnt;             // Number of associated aux entries
    Elf64_Word      vn_file;            // Offset of filename for th
    Elf64_Word      vn_aux;             // Offset in bytes to vernaux array
    Elf64_Word      vn_next;            // Offset in bytes to next verne
} Elf64_Verneed;
...
typedef struct {
    ...
    Elf32_Word      vna_next;           // Offset in bytes to next verna
} Elf32_Vernaux;
...
typedef struct {
    ...
    Elf64_Word      vna_next;           // Offset in bytes to next verna
} Elf64_Vernaux;
...
// This entry gives some information about the FPU initialization done by the kernel
...
/* Note section contents. Each entry in the note section begins with a
...
// These values can appear in word 0 of the NT_GNU_ABI_TAG note section entry
...
/* Build ID bits as generated by ld --build-id. The descriptor
...
#define R_68K_TLS_LE32      37          // 32 bit offset for LE
#define R_68K_TLS_LE16      38          // 16 bit offset for LE
#define R_68K_TLS_LE8       39          // 8 bit offset for LE
...
#define R_386_TLS_GD        18          // Direct 32 bit for GNU version general dynamic thread local data
#define R_386_TLS_LDM       19          // Direct 32 bit for GNU version local dynamic thread local data in LE code
#define R_386_16            20
...
#define R_386_TLS_GD_CALL   26          // Relocation for call __tls_get_addr()
#define R_386_TLS_GD_POP    27          // Tag for popl in GD TLS code
#define R_386_TLS_LDM_32    28          // Direct 32 bit for local dynamic thread local data in LE code
#define R_386_TLS_LDM_PUSH  29          // Tag for pushl in LDM TLS code
#define R_386_TLS_LDM_CALL  30          // Relocation for call __tls_get_addr() in LDM code
#define R_386_TLS_LDM_POP   31          // Tag for popl in LDM TLS code
#define R_386_TLS_LDO_32    32          // Offset relative to TLS block
#define R_386_TLS_IE_32     33          // GOT entry for negated static TLS block offset
#define R_386_TLS_LE_32     34          // Negated offset relative to stat TLS block
...
#define R_386_TLS_DESC      41          // TLS descriptor containi pointer to code and to argument
...
#define R_390_TLS_GOTIE20   60      // 20 bit GOT offset for static T block offset
#define R_390_NUM           61
...
#define R_MN10300_GNU_VTINHERI  7       // Ancient C++ vtable garbage..
