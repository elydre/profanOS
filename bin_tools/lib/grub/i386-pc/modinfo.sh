...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 15.2.1 20250813'
...
grub_cflags='-std=gnu11 -Wno-error -Wno-error=dangling-pointer -Wno-unterminated-string-initialization -Wno-array-bounds'
grub_cppflags=' -D_FILE_OFFSET_BITS=64'
grub_ccasflags='-std=gnu11 -Wno-error -Wno-error=dangling-pointer -Wno-unterminated-string-initialization -Wno-array-bounds'
grub_ldflags=''
